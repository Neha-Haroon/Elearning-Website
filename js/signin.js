...
showPassword.addEventListener('click', (event) => {
    if (password.type === 'password') {
        showPassword.classList.replace('uil-eye', 'uil-eye-slash');

        password.type = 'text';
    }
    else {
        showPassword.classList.replace('uil-eye-slash', 'uil-eye');
...
//         showConfirmPassword.classList.replace('uil-eye', 'uil-eye-slash');

//         confirmPassword.type = 'text';
//     }
//     else {
//         showConfirmPassword.classList.replace('uil-eye-slash', 'uil-eye');
...
const showError = (element, text) => {
    ...
    if (element === nameError) {
        document.querySelector('#nameSection').style.borderBottom = '2px solid rgb(187, 64, 64)';
        document.querySelector('#nameExcla').style.visibility = 'visible';
    }


    if (element === emailError) {
        document.querySelector('#emailSection').style.borderBottom = '2px solid rgb(187, 64, 64)';
        document.querySelector('#emailExcla').style.visibility = 'visible';
    }


    if (element === passwordError) {
        document.querySelector('#passSection').style.borderBottom = '2px solid rgb(187, 64, 64)';
        document.querySelector('#passExcla').style.visibility = 'visible';
    }


    if (element === confirmPasswordError) {
        document.querySelector('#confirmPassSection').style.borderBottom = '2px solid rgb(187, 64, 64)';
...
const showSuccess = (element) => {
    ...
    if (element === nameError) {
        document.querySelector('#nameSection').style.borderBottom = '2px solid green';
        document.querySelector('#nameExcla').style.visibility = 'hidden';
    }


    if (element === emailError) {
        document.querySelector('#emailSection').style.borderBottom = '2px solid green';
        document.querySelector('#emailExcla').style.visibility = 'hidden';
    }


    if (element === passwordError) {
        document.querySelector('#passSection').style.borderBottom = '2px solid green';
        document.querySelector('#passExcla').style.visibility = 'hidden';
    }


    if (element === confirmPasswordError) {
        document.querySelector('#confirmPassSection').style.borderBottom = '2px solid green';
